    ...
    if (isset($_POST['btnSignin'])) {
        ...
        if (empty($txt_email) || empty($txt_password)) {
            ...
            if (mysqli_num_rows($sqlValidate) > 0) {
				...
				$_SESSION['session_id'] = $rowValidate['Id'];
	...
	<div class="main-container">
		...
		<div class="contents" id="contents-id" style="padding-bottom: 100px;">
			<div class="contents-container">
				<form class="frmSignup" id="frmSignup-id" action="../pages/Signin.php" method="POST">
					<h1 style="text-align: center;">Sign In</h1>
					<br>
					<p style="text-align: center; font-size: 16px;">Please enter your email and password</p>
					<br>
					...
					<br>
					<p class="alt-sign"><a href="Signup.php">Don't have an account? Create one</a></p>
				</form>
			</div>
		</div>
